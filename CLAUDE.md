...
- `adveron-ds/` (Adveron's design system + change-review app) → **Adveron DS**
...
- cwd inside `adveron-ds/` → you are **Adveron DS** (Adveron's own design system + the visual change-review app; read `adveron-ds/CLAUDE.md` first).
