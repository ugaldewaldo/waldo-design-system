...
#
# waldo-ds.css is a token-free component-class layer that consumes the HSL theme
# (waldo-shadcn-theme.css) via hsl(var(--token)). Consumers (index.html, labs
# prototypes) must link the theme FIRST, then waldo-ds.css. Edit component CSS in
# tools/waldo-ds.styles.css; then run this. Never edit waldo-ds.css by hand.
#
